...
= 1.1.3 =
Improved Pro plugin hook compatibility by adjusting initialization order, added Elementor Pro forms integration support, and fixed fields layout rendering.

= 1.1.2 =
Refined heuristic scanner to reduce false positives, fixed URL obfuscator 404 redirection, and updated admin dashboard threat status display.
